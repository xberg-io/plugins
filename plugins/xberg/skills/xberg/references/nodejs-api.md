...
```typescript
// ESM
import { extractFile, batchExtractFiles } from "@xberg-io/xberg";

// CommonJS
const { extractFile, batchExtractFiles } = require("@xberg-io/xberg");
```
...
**Throws**: `ParsingError`, `OcrError`, `ValidationError`, `XbergError`
...
```typescript
import { extractBytes } from "@xberg-io/xberg";
...
```typescript
import { extractBytesSync } from "@xberg-io/xberg";
...
```typescript
import { batchExtractFilesSync } from "@xberg-io/xberg";
...
```typescript
import { batchExtractBytes } from "@xberg-io/xberg";
import { readFile } from "fs/promises";
...
```typescript
import { batchExtractBytesSync } from "@xberg-io/xberg";
import { readFileSync } from "fs";
...
```typescript
import { createWorkerPool } from "@xberg-io/xberg";
...
```typescript
import { createWorkerPool, extractFileInWorker, closeWorkerPool } from "@xberg-io/xberg";
...
```typescript
import { createWorkerPool, batchExtractFilesInWorker, closeWorkerPool } from "@xberg-io/xberg";
...
```typescript
import { createWorkerPool, getWorkerPoolStats } from "@xberg-io/xberg";
...
```typescript
import { createWorkerPool, closeWorkerPool } from "@xberg-io/xberg";
...
- `XbergError` — Base class for all Xberg errors
...
```typescript
import { registerPostProcessor, extractFile } from "@xberg-io/xberg";
...
```typescript
import { registerValidator, extractFile } from "@xberg-io/xberg";
...
```typescript
import { registerOcrBackend, extractFile } from "@xberg-io/xberg";
...
```typescript
import { GutenOcrBackend, registerOcrBackend, extractFile } from "@xberg-io/xberg";
...
```typescript
import { detectMimeType } from "@xberg-io/xberg";
import { readFileSync } from "fs";
...
```typescript
import { detectMimeTypeFromPath } from "@xberg-io/xberg";
...
```typescript
import { getExtensionsForMime } from "@xberg-io/xberg";
...
```typescript
import { validateMimeType } from "@xberg-io/xberg";
...
```typescript
import { ExtractionConfig, extractFile } from "@xberg-io/xberg";

const config = ExtractionConfig.fromFile("./xberg.toml");
...
// Searches for xberg.{toml,yaml,json} in current directory and parents
...
```typescript
import { getEmbeddingPreset } from "@xberg-io/xberg";
...
```typescript
import { listEmbeddingPresets } from "@xberg-io/xberg";
...
All types are exported from `@xberg-io/xberg`:
